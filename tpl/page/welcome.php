...
<main class="lup-arrival">
	<section class="lup-arrival-hero">
		<div class="lup-arrival-grid" aria-hidden="true"></div><div class="lup-arrival-horizon" aria-hidden="true"></div>
		...
		<div class="lup-arrival-copy"><p class="lup-arrival-kicker"><i class="fas fa-map-marker-alt"></i> ENTDECKEN · HINGEHEN · VERBINDEN</p><h1>Das Leben findet<br><em>nicht im Feed</em> statt.</h1><p>LinkUUp zeigt dir Orte, die du wirklich besuchen kannst. Damit aus einem Impuls ein echter Abend, ein Gespräch oder ein neues Gesicht wird.</p><div class="lup-arrival-actions"><a href="<?=$appURL?>"><i class="fas fa-compass"></i> LinkUUp öffnen</a><a href="#lup-arrival-journey">Die Idee ansehen <i class="fas fa-arrow-down"></i></a></div></div>
		<div class="lup-arrival-location" aria-hidden="true"><span class="lup-arrival-pulse"></span><i class="fas fa-map-marker-alt"></i><b>DEIN NÄCHSTER ORT</b><small>beginnt außerhalb des Bildschirms</small></div>
	</section>
